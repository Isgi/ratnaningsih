...
class FPDF_AutoWrapTable extends FPDF {
    ...
    $this->Cell(10,15,'Keterangan :',0,1);
    $this->Cell(100,15,'Jumlah Debit ');
    $this->Cell(10,15,': Rp.'.$jumlah_debit.',-',0,1);
    $this->Cell(100,15,'Jumlah Kredit ');
    $this->Cell(10,15,': Rp.'.$jumlah_kredit.',-',0,1);
    $this->Cell(10,15,'',0,1);
