          ...
          <div class="content">
            <form class="" action="<?php echo site_url('bitempembayaran/actadd') ?>" method="post">
                ...
                <div class="form-group">
                  ...
                  {data_program}
                  <div class="radio">
                      <input type="radio" class="form-control"  name="program" required value="{id}"> {nama}
                  </div>
                  {/data_program}
                </div>
                <div class="form-group">
                    ...
                    <div class="checkbox" required>
                      <label><input type="checkbox" name="sekolah[]" multiple id="checkItem" value="{id_sekolah}"><div style="text-transform:uppercase">{nama_sekolah} {nama_derajat}</div></label>
                    </div>
                    {/data_derajat}
                </div>
                <div class="form-group">
