  ...
  <form class="form-inline" action="<?php echo site_url('transaksi/'.$this->uri->segment(2)) ?>" method="get">
    ...
    <div class="">
      <table class="table table-striped">
        <thead>
          <tr>
            <th class="no-sort">Nama Pengeluaran</th>
            <th class="no-sort">Kode Pengeluaran</th>
        ...
        <tbody>
          ...
          <tr class="odd gradeX">
            <td><?php echo $data->jenis_transaksi_nama?></td>
            <td><?php echo $data->jenis_transaksi_kode?></td>
